...
public void actionPerformed(ActionEvent arg0) {
	...
	int val4 = Integer.parseInt(text4.getText());
	int val5 = Integer.parseInt(text5.getText());
	Calculation_lib clib2 = new Calculation_lib(val1, val2);
	text6.setText(String.valueOf(clib.getMinus()));
